<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
      ...
      $db->exec("INSERT INTO products (title,image,description,price,create_date) VALUES ('$title','$imagePath','$description','$price','$date')");
  ...
  <body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="number" step=".01" name="price" class="form-control" value="<?php print($price)?>">
